...
func (u *UserRoute) Run() {
	...
	group.POST("/login", middlewares.Authenticate(), u.controller.GetUserController().Login)
	group.POST("/register", middlewares.Authenticate(), u.controller.GetUserController().Register)
